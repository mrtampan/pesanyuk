...
<!-- ADD NEW -->
       ...
       <template slot="thead">
        <vs-th sort-key="nama">Nama Pelanggan</vs-th>
        <vs-th sort-key="nama">No Hp</vs-th>
        <vs-th sort-key="nama">Email</vs-th>
      ...
      <template slot-scope="{data}">
        <tbody>
          <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
            ...
            <vs-td>
              <p class="product-email">{{ tr.jumlah }}</p>
            </vs-td>
          </vs-tr>
        </tbody>
      </template>
...
import moduledataLaporanPelanggan from '@/store/laporan/details/pelanggan/moduleLaporanPelanggan.js' //penamaan moduleDataSupplier diganti sesual menui
...
export default {
  ...
  created () {
    if (!moduledataLaporanPelanggan.isRegistered) {
      this.$store.registerModule('dataCustomer', moduledataLaporanPelanggan) //dataSupplier ganti dengan dataNamamenu
      moduledataLaporanPelanggan.isRegistered = true
    }
    const id = {
      idBusiness : this.$store.state.AppActiveUser.id_business
    }
    this.$store.dispatch('dataCustomer/fetchDataCustomerItems', id)
  },
  mounted () {
    this.isMounted = true
  }
