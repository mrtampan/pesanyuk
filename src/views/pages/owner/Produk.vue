      ...
      <div slot="header" class="flex flex-wrap-reverse items-center flex-grow justify-between">
        ...
        <div class="flex flex-wrap-reverse items-center">
         ...
         <vs-button @click="popupActive=true" class="p-3 mb-4 mr-4 rounded-lg cursor-pointer shadow-md flex items-center justify-between text-lg font-medium text-base text-white bg-success">Impor Produk .xlsx</vs-button>
          ...
          <!-- ADD NEW -->
          <router-link :to="`/owner/product/add`" class="p-3 mb-4 mr-4 rounded-lg cursor-pointer shadow-md flex items-center justify-between text-lg font-medium text-base text-white bg-primary" >
      ...
      <template slot-scope="{data}">
        <tbody>
          <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
            ...
            <vs-td>
              <p class="product-category">{{ tr.featured }}</p>
            </vs-td>
            <vs-td>
