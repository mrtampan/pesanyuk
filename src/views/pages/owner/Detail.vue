...
<template>
  <div id="data-list-thumb-view" class="data-list-container">
    ...
    <vs-table ref="table" multiple v-model="selected" pagination :max-items="itemsPerPage" search :data="detail">
      ...
      <template slot="thead">
        ...
        <vs-th sort-key="popularity">Popularitas</vs-th>
...
import moduleDataList from '@/store/produk/moduleProduk.js'
