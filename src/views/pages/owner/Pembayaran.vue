    ...
    <vs-table ref="table" multiple v-model="selected" pagination :max-items="itemsPerPage" search :data="payments">
      ...
      <div slot="header" class="flex flex-wrap-reverse items-center flex-grow justify-between">
       ...
       <template slot="thead">
        ...
        <vs-th sort-key="tf">Bukti Transfer</vs-th>
        ...
        <tbody>
          <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
            ...
            <vs-td class="img-container">
              <img :src="tr.bukti" class="product-img" />
            </vs-td>
...
export default {
  ...
  methods: {
    ...
    acceptAlert () {
      this.$store.dispatch('dataPayment/removeItem', this.popupData.id).catch(err => { console.error(err) })
      this.$vs.notify({
        color: 'success',
