...
<div class="vx-row">
  <div class="vx-col w-full md:w-full lg:w-2/3 xl:w-2/3">
    <div class="vx-row">
      <!-- total -->
      <div class="vx-col w-full mb-3 md:w-2/3 lg:w-2/3 xl:w-1/3">
       <statistics-card-line
          hideChart
          class="mb-base"
          icon="ShoppingCartIcon"
          icon-right
          statistic="Rp. 2.326.236"
          statisticTitle="Total Penjualan Kotor"
        />
        ...
        <statistics-card-line
          ...
          icon-right
          statistic="Rp. 2.326.236"
          statisticTitle="Total Keuntungan"
          color="warning"
        />
        ...
        <statistics-card-line
          ...
          icon-right
          statistic="Rp. 2.326.236"
          statisticTitle="Rata Rata Nilai Transaksi"
          color="warning"
        />

      </div>
      <!-- tipe order -->
      <div class="vx-col w-full md:w-1/3 lg:w-1/3 xl:w-2/3">
        <vx-card title="Perbandingan Tipe Order">
          <!-- CHART -->
          <div slot="no-body">
            <vue-apex-charts
              type="donut"
    ...
    <!-- transaksi -->
    <div id="email-app" class=" mt-12 border border-solid d-theme-border-grey-light rounded relative overflow-hidden">
  ...
  <div class="vx-col md:w-1/3 lg:w-1/3 xl:w-1/3" >
    <vx-card content-color="#fff" card-background="#fff" class="mb-8">
        <vs-row class="mb-12">
          <vs-col vs-type="flex" vs-justify="left" vs-align="left" vs-lg="5" vs-sm="2" vs-xs="">
            <h1 class="text-2xl font-bold ">Produk Terlaris</h1>
          </vs-col>
          <vs-col  vs-type="flex"  vs-justify="right" vs-align="right" vs-lg="7" vs-sm="4" vs-xs="12">
              <vs-button size="small"  color="primary" type="gradient">Tampilkan Semua</vs-button>
          </vs-col>
          </vs-row>        
          
          <div class="vx-row">
          <div class="vx-col sm:w-full md:w-1/2 lg:w-1/2 xl:w-1/6 mb-4">
          <vs-avatar size="40px" src="https://avatars2.githubusercontent.com/u/31676496?s=460&v=4"/>        
          </div>
          <div class="vx-col sm:w-full md:w-1/2 lg:w-1/2 xl:w-1/3">          
          <h2 class="text-lg font-bold">Burger Jumbo</h2>
          </div>
          <div class="vx-col sm:w-full md:w-1/2 lg:w-1/2 xl:w-1/3">
             <h3 class="text-lg font-bold">250</h3>
          </div>
        </div>
...
import moduleDataTransaction from '@/store/transaksi/moduleTransaksi.js'
