    ...
    <div id="access-conttrol-editor">
        <vx-card>
            ...
            <div class="demo-alignment mb-base">
                <vs-radio v-model="nama_role" vs-value="owner">Owner</vs-radio>
                <vs-radio v-model="nama_role" vs-value="admin">Admin</vs-radio>
                <vs-radio v-model="nama_role" vs-value="public">Public</vs-radio>
            </div>

             <vx-card title="Buttons" no-shadow card-border code-toggler>
                <vs-button v-show="$acl.check('owner')" class="mr-4 mb-2">Owner</vs-button>
                <vs-button v-show="$acl.check('admin')">Admin</vs-button>
                <vs-button v-show="$acl.check('public')">Public</vs-button>
                <template slot="codeContainer">
&lt;vs-button v-show=&quot;$acl.check('owner')&quot; class=&quot;mr-4&quot;&gt;Owner&lt;/vs-button&gt;
&lt;vs-button v-show=&quot;$acl.check('admin')&quot;&gt;Admin&lt;/vs-button&gt;
&lt;vs-button v-show=&quot;$acl.check('public')&quot;&gt;Admin&lt;/vs-button&gt;
                </template>
            </vx-card>
...
export default{
  data () {
    return {
      nama_role: this.$acl.get[0]
    }
  },
  watch: {
    nama_role (val) {
      this.$store.dispatch('updateUserRole', {aclChangeRole: this.$acl.change, nama_role: val})
    }
  }
}
</script>
