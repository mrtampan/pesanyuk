...
<template>
  <div class="layout--main" :class="[layoutTypeClass, navbarClasses, footerClasses, {'no-scroll': isAppPage}]" >
    ...
    <v-nav-menu :navMenuItems="navMenuItems" title="Pesanyuk" parent=".layout--main" />
          ...
          <div class="router-content">
            <transition :name="routerTransition">
              <div
                ...
                class="router-header flex flex-wrap items-center mb-10"
              >
                <div
...
import navMenuItems from '@/layouts/components/vertical-nav-menu/navMenuItemsCourier.js'
import TheCustomizer from '@/layouts/components/customizer/TheCustomizer.vue'
import TheNavbarVertical from '@/layouts/components/navbar/TheNavbarVertical.vue'
import TheFooter from '@/layouts/components/TheFooter.vue'
import themeConfig from '@/../themeConfig.js'
import VNavMenu from '@/layouts/components/vertical-nav-menu/VerticalNavMenuCourier.vue'
...
export default {
  ...
  created () {
    const
      color = this.navbarColor === '#fff' && this.isThemeDark ? '#10163a' : this.navbarColor
    this.updateNavbarColor(color)
