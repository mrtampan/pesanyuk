      ...
      <div @mouseenter="mouseEnter" @mouseleave="mouseLeave">
        ...
        <div class="header-sidebar flex items-end justify-between" slot="header">
          ...
          <router-link tag="div" class="vx-logo cursor-pointer flex items-center" to="/">
            ...
            <span class="vx-logo-text text-black" v-show="isMouseEnter || !reduce" v-if="title">{{ title }}</span>
          </router-link>
          <!-- /Logo -->
        ...
        <div class="m-3 mt-5 rounded-lg px-5 py-1 flex justify-between flex-row-reverse items-center border-solid border-primary" style="background: #f9f9f9;">
          <span class="p-0 mr-0 inline-flex rounded-full feather-icon select-none relative text-white" >
            <vs-avatar size="large" src="https://ps.w.org/ratapay/assets/icon-128x128.png"/>
          </span>
          <div class="truncate">
            <h3 class="mb-1 font-bold">1.000.000</h3>
            <span>Saldo Ratapay</span>
          </div>
        </div>
        <div class="m-3 my-5 mb-10 rounded-lg px-5 py-2 flex bg-primary cursor-pointer text-center shadow-md divide-y divide-gray-400">
          <span class="feather-icon truncate text-white font-bold rounded m-auto">
            pesan.app/tokomu &nbsp; | &nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6 ml-1 stroke-current text-white text-opacity-80 feather feather-external-link"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>
          </span>
        </div>
          ...
          <div class="m-3 p-2 mt-10">
            <vx-card
                content-color="#fff"
                class="truncate p-1 text-center"
                card-background="linear-gradient(to right, #ffa700, #fbc600)">
                <img :src="require('@/assets/images/pages/graphic-1.png')" alt="graphic" width="130" class="mx-auto mb-1">
                <h3 class="font-bold">Fitur Baru</h3><br>
                <p class="mb-5 text-black whitespace-normal">Sekarang Anda lebih mudah mengetahui orderan baru dari realtime notifikasi</p>
              <vs-button color="black" type="filled">Lihat Fitur Baru</vs-button>
            </vx-card>
          </div>

          <div class="my-3 w-full text-center">
            <span class="text-grey text-xs">HA v 0.0.1</span>
          </div>
