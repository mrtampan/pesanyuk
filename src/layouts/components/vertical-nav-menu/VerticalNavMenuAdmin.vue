  ...
  <div class="parentx">
    ...
    <vs-sidebar
      ...
      <div @mouseenter="mouseEnter" @mouseleave="mouseLeave">
        ...
        <!-- Menu Items -->
        <component :is="scrollbarTag" ref="verticalNavMenuPs" class="scroll-area-v-nav-menu pt-10" :settings="settings" @ps-scroll-y="psSectionScroll" @scroll="psSectionScroll" :key="$vs.rtl">
          ...
          <!-- <div class="m-3 p-2 mt-2 text-center item-center">
          <vs-switch color="dark" icon-pack="feather" class="mx-auto mb-10" vs-icon-on="icon-check-circle" vs-icon-off="icon-slash" v-model="darkmode">
            <span slot="on">Dark Mode On</span>
            <span slot="off">Dark Mode Off</span>
          </vs-switch>
          </div>-->
        </component>
        <!-- /Menu Items -->
